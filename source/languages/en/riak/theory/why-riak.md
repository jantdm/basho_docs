...
You should definitely take a close look at Riak whenever your data does not fit on a single server.  Distributed databases are a problem which is **very** hard to solve well.
